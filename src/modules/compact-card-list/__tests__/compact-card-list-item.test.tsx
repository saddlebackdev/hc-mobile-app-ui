...
describe('CompactCardListItem', () => {
  ...
  describe('Rendering', () => {
    it('renders itself correctly', () => {
      const wrapper = render(
        <ThemeProvider theme={defaultTheme}>
          <CompactCardListItem title='TestCard' icon={IconShapeHeart} leftGradientViewStyle={{ gradientColors }} />
        </ThemeProvider>,
      );
    ...
    it('hides icon when it is null', () => {
      const wrapper = render(
        <ThemeProvider theme={defaultTheme}>
          <CompactCardListItem title='TestCard' icon={null} leftGradientViewStyle={{ gradientColors }} />
        </ThemeProvider>,
      );
  ...
  describe('Interactions', () => {
    it('should call onPress method when pressed', () => {
      const wrapper = render(
        <ThemeProvider theme={defaultTheme}>
          <CompactCardListItem title='TestCard' onPress={onPressMock} icon={IconShapeHeart} leftGradientViewStyle={{ gradientColors }} />
        </ThemeProvider>,
      );
